...
# lista de productos
lista_comidas = ['pollo', 'Cordero', 'Salmon', 'Kebab', 'Pizza', 'Carnitas', 'Tacos', 'Pasta']
lista_bebidas = ['Agua', 'Soda', 'Jugo', 'Cola', 'Vino1', 'Vino2', 'Vino3','Vino4']
...
for postres in lista_postres:
    ...
    cuadros_postres[contador] = Entry(panel_postres, font=('Dosis', 18, 'bold'),
                                     bd=1, width=6, state=DISABLED, textvariable=texto_postres[contador])
...
# Botones derecha
botenes = ['total', 'recibo', 'guardar', 'resetear']
botones_creados = []
columnas = 0
for boton in botenes:
